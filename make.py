...
def make_dummy_user():    
    ...
    client_idp.admin_create_user(UserPoolId=stack_outputs['userPoolID'], Username='test@test.de')
    client_idp.confirm_signup(UserPoolId=stack_outputs['userPoolID'], Username='test@test.de')
